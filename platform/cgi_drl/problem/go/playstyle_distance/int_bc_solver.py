        ...
        for unit_of_candidate in unit_game_count:
            ...
            for query_style in query_styles:
                ...
                for candidate_style in candidate_styles:
                    ...
                    distances, jaccard_index, valid_state_count = compute_similarity(query_style_info, candidate_style_info)
                    intersection_state_counts.append(valid_state_count)
                    all_style_distances[candidate_style] = distances
                    all_state_spaces[candidate_style] = valid_state_count
                ...
                for candidate_style in candidate_styles:
                    ...
                    for d in all_style_distances[candidate_style]:
                        similar_probability += d / state_space
