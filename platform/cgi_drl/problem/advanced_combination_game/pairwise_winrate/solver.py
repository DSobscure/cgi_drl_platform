...
def launch(problem_config):
    ...
    from cgi_drl.measure_model.pairwise_winrate.trainer import PairwiseWinrateTrainer
    model = PairwiseWinrateTrainer(pairwise_winrate_config)

    # setup record
    from cgi_drl.data_storage.match_records.advanced_combination_game_record import AdvancedCombinationGameMatchResultBuffer
