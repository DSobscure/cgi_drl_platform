...
def launch(problem_config):
    ...
    from cgi_drl.environment.dmlab30.dmlab30_observation_preprocessor import DMLab30ObservationPreprocessor
    preprocessor = DMLab30ObservationPreprocessor(preprocessor_config)
    ...
    solver = DMLab30PpoSolver(problem_config)
...
class DMLab30PpoSolver(PpoSolver):
