...
def launch(problem_config):
    ...
    result_path += "code0"
    with open(result_path + "_playstyle_bd_similarity.csv", "w", newline="") as distance_csvfile, open(result_path + "_playstyle_bd_similarity_iou.csv", "w", newline="") as iou_csvfile:
