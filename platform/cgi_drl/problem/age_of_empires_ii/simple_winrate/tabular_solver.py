...
def launch(problem_config):
    ...
    from cgi_drl.measure_model.simple_winrate.tabular_trainer import SimpleWinrateTrainer
    model = SimpleWinrateTrainer(winr_config)

    # setup record
    from cgi_drl.data_storage.match_records.age_of_empires_ii_tabular_match_result_buffer import AgeOfEmpiresIIMatchResultBuffer
