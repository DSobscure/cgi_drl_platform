from cgi_drl.problem.workflow_template.neural_counter_table_template import NeuralCounterTableTorchSolver
...
def launch(problem_config):
    ...
    from cgi_drl.measure_model.neural_counter_table.torch_trainer import NeuralCounterTableTrainer
    ...
    solver = NeuralCounterTableTorchSolver(problem_config)
