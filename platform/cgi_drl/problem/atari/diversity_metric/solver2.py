...
def launch(problem_config):
    ...
    result_path = problem_config["result_path"] + "_t_02"
    ...
    for algorithm in algorithms:
        with open(result_path + "_{}.csv".format(algorithm), "w", newline="") as csvfile:
            writer = csv.writer(csvfile)
            observed_trajectories = {}
            diversed_episode_count = 0
            for i_model in range(model_count):
                for i_episode in range(episode_count):
                    trajectory_name = "{}_model{}_episode{}".format(algorithm, i_model + 1, i_episode + 1)
                    ...
                    # print("Algorithm {}: {}/({},{})".format(algorithm, diversed_episode_count, i_model + 1, i_episode + 1), end='\r')
                    writer.writerow([diversed_episode_count])
            print("Algorithm {}: {}/{}".format(algorithm, diversed_episode_count, model_count * episode_count))
