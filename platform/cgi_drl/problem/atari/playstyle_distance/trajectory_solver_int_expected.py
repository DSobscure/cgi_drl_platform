...
def launch(problem_config):
    ...
    for target_trajectory in target_trajectories:
        ...
        for reference_style in reference_styles:
            ...
            playstyle_distances, jaccard_index, state_space, expected_weights = compute_similarity(target_style_info, reference_style_info, threshold_count)
...
def compute_similarity(style_A, style_B, threshold_count):
    ...
    for s in intersection_state:
        ...
        valid_state_count += 1
        expected_weight = (style_A["state_count"][s] / overlapping_count_in_A + style_B["state_count"][s] / overlapping_count_in_B) / 2
