...
def launch(problem_config):
    ...
    for target_trajectory in target_trajectories:
        ...
        for reference_style in reference_styles:
            ...
            jaccard_index = compute_similarity(target_style_info, reference_style_info, threshold_count)
            playstyle_distances[reference_style] = jaccard_index
...
def compute_similarity(style_A, style_B, threshold_count):
    ...
    jaccard_index = (overlapping_count_in_A / all_count_in_A + overlapping_count_in_B / all_count_in_B) / 2
