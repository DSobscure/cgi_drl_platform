...
class DefaultTemplate(dict):
    def __init__(self, config):
        self["algorithm_scope"] = config.get("algorithm_scope", "NCT")
        ...
        def create_tensorflow_variables():
            ...
            player1_combo_placeholder = tf.placeholder(shape = [None, 136], dtype = tf.float32, name = "player1_combo_placeholder")
            player2_combo_placeholder = tf.placeholder(shape = [None, 136], dtype = tf.float32, name = "player2_combo_placeholder")
        ...
        self["model_define_path"] = config.get("model_define_path", "measure_model.neural_counter_table.nn_model.shared.prediction_model")
