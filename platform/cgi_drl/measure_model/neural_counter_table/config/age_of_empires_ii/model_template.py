...
class DefaultTemplate(dict):
    def __init__(self, config):
        ...
        def create_tensorflow_variables():
            ...
            player1_combo_placeholder = tf.placeholder(shape = [None, 45], dtype = tf.float32, name = "player1_combo_placeholder")
            player2_combo_placeholder = tf.placeholder(shape = [None, 45], dtype = tf.float32, name = "player2_combo_placeholder")
