...
class UAI2021Template(dict):
    def __init__(self, config):
        ...
        self["visual_observation_dimension"] = config.get("visual_observation_dimension", [84, 84, 1])
        self["compressed_visual_observation_dimension"] = config.get("compressed_visual_observation_dimension", [84, 84, 1])
        self["visual_observation_frame_count"] = config.get("visual_observation_frame_count", 4)
        self["model_define_path"] = config.get("model_define_path", "representation_model.hsd.nn_model.atari.encoder_model_uai2021")
        ...
        self["cnn_latent_block_sizes"] = config.get("cnn_latent_block_sizes", 121)
        self["output_dimensions"] = config.get("output_dimensions", [[121, 32]])
